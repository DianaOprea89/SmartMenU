<template>
  <div class="container">
    <div class="m-2 icon-container">
      <router-link :to="`/restaurant/${encodeURIComponent(restaurantName)}/accessRestaurant/viewMenu/checkout`"
    ...
    <div class="m-2 icon-container">
      <router-link :to="`/restaurant/${encodeURIComponent(restaurantName)}/accessRestaurant`"
                   class="go-back d-flex justify-content-start ">
            ...
            <li v-for="mealOption in filteredMealOptions" :key="mealOption._id"
              ...
              <div class="meal-content">
                ...
                <div class="meal-footer">
                  <div class="meal-quantity">{{ mealOption.quantity }} {{ mealOption.unit }}</div>
                  <div class="meal-price"> <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="black"
                  ...
                  </svg>{{ mealOption.price }} RON</div>
                  <div>Alergeni: {{ mealOption.allergens.join(', ') }}</div>
                  <div class="button-container" @click="openDialog">
                    <button type="button" class="btn btn-outline-secondary m-2">Add</button>
...
.meal-footer {
  display: flex;
  justify-content: space-between; /* This will push the content to opposite ends */
...
.btn-outline-secondary {
  border-radius: 20px; /* This will make the corners more rounded */
}
