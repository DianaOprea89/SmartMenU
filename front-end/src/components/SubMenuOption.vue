<template>
  <div class="container">
    ...
    <div class="menu-container" v-if="restaurantData && restaurantData.subMenuOptions">
      <div v-for="(subMenuOption, index) in restaurantData.subMenuOptions" :key="index">
        ...
        <div class="meal-options menu-option-row">
          <div v-for="mealOption in subMenuOption.mealOptions" :key="mealOption._id" class="meal-option-card">
           <img :src="mealOption.photoLink" alt="Menu item" class="menu-option-image">
            <h3>{{ mealOption.optionName }} ({{ mealOption.quantity }} {{ mealOption.unit }})</h3>
            <div class="meal-details">
              <p><strong>Ingredients:</strong> {{ mealOption.ingredients }}</p>
              <p><strong>Description:</strong> {{ mealOption.description }}</p>
