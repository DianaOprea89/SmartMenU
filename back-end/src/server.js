...
app.get('/api/restaurant/:name', verifyToken, async (req, res) => {
...
app.get('/api/getRestaurants', verifyToken, async (req, res) => {
    try {
        const user = await User.findById(req.user.userId).populate('restaurants');
        if (!user) {
            return res.status(404).json({ message: 'User not found' });
...
app.post('/api/addRestaurants', verifyToken, async (req, res) => {
...
app.post('/api/addOptionMenuRestaurants', verifyToken, async (req, res) => {
    try {
...
app.post('/api/addSubOptionMenuRestaurants', verifyToken, async (req, res) => {
    try {
...
app.put('/api/editMealOption/:userId/:restaurantId/:menuOptionId/:subMenuOptionId/:mealOptionId', verifyToken, async (req, res) => {
    try {
...
app.delete('/api/removeMealOption/:userId/:restaurantId/:menuOptionId/:subMenuOptionId/:mealOptionId', verifyToken, async (req, res) => {
...
app.put('/api/updateMealOption/:userId/:restaurantId/:menuOptionId/:subMenuOptionId/:mealOptionId', verifyToken, async (req, res) => {
    try {
        const { userId, restaurantId, menuOptionId, subMenuOptionId, mealOptionId } = req.params;
        const { photoLink, optionName, quantity, ingredients, price, description, unit } = req.body;
...
app.put('/api/editSubMenuOption/:userId/:restaurantId/:menuOptionId/:subMenuOptionId', verifyToken, async (req, res) => {
    try {
...
app.delete('/api/removeSubMenuOption/:userId/:restaurantId/:menuOptionId/:subMenuOptionId', verifyToken, async (req, res) => {
    try {
        const { userId, restaurantId, menuOptionId, subMenuOptionId } = req.params;
        const user = await User.findById(userId);
        if (!user) {
...
app.post('/api/addMealOption/:userId/:restaurantId/:menuOptionId/:subMenuOptionId', verifyToken, async (req, res) => {
    try {
        const { userId, restaurantId, menuOptionId, subMenuOptionId } = req.params;
...
app.put('/api/editRestaurant/:userId/:restaurantId', verifyToken, async (req, res) => {
    try {
        const { userId, restaurantId } = req.params;
...
app.delete('/api/removeOptionMenuRestaurants/:userId/:restaurantId/:menuOptionId', verifyToken, async (req, res) => {
...
app.put('/api/editOptionMenuRestaurants/:userId/:restaurantId/:menuOptionId', verifyToken, async (req, res) => {
    try {
        const { userId, restaurantId, menuOptionId } = req.params;
        const { photoLink, optionName } = req.body;
        const user = await User.findById(userId);
        if (!user) {
            return res.status(404).json({ message: 'User not found' });
        }
